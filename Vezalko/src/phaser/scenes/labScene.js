...
export default class LabScene extends Phaser.Scene {
  ...
  preload() {
        this.load.image('avatar1', '/avatars/avatar1.png');
        this.load.image('avatar2', '/avatars/avatar2.png');
        this.load.image('avatar3', '/avatars/avatar3.png');
        this.load.image('avatar4', '/avatars/avatar4.png');
        this.load.image('avatar5', '/avatars/avatar5.png');
        this.load.image('avatar6', '/avatars/avatar6.png');
        this.load.image('avatar7', '/avatars/avatar7.png');
        this.load.image('avatar8', '/avatars/avatar8.png');
        this.load.image('avatar9', '/avatars/avatar9.png');
        this.load.image('avatar10', '/avatars/avatar10.png');
        this.load.image('avatar11', '/avatars/avatar11.png');
    }
  ...
  create() {
    ...
    const logoutButton = this.add.text(40, 30, '↩ Logout', {
        ...
        .setOrigin(0, 0)
        .setInteractive({ useHandCursor: true })
        .on('pointerover', () => logoutButton.setStyle({ color: '#4F46E5' }))
        .on('pointerout', () => logoutButton.setStyle({ color: '#6366F1' }))
        .on('pointerdown', () => {
    ...
    scoreButtonBg.fillStyle(0x6366F1, 1);
    ...
    const scoreButton = this.add.text(width - buttonWidth / 2 - rightMargin, topMargin + buttonHeight / 2, 'Leaderboard', {
        ...
        .on('pointerover', () => {
            scoreButtonBg.clear();
            scoreButtonBg.fillStyle(0x4F46E5, 1);
            scoreButtonBg.fillRoundedRect(width - buttonWidth - rightMargin, topMargin, buttonWidth, buttonHeight, cornerRadius);
        })
        .on('pointerout', () => {
            scoreButtonBg.clear();
  ...
  showWorkspaceSelectionModal() {
    ...
    modalBorder.lineStyle(3, 0x6366F1, 1);
    ...
    electricBtnBg.fillStyle(0x6366F1, 1);
    ...
    logicBtnBg.fillStyle(0xF59E0B, 1);
    ...
    electricBtn.on('pointerover', () => {
      electricBtnBg.clear();
      electricBtnBg.fillStyle(0x4F46E5, 1);
      electricBtnBg.fillRoundedRect(width / 2 - 300, electricBtnY - 30, 600, 70, 10);
    });
    ...
    logicBtn.on('pointerover', () => {
      logicBtnBg.clear();
      logicBtnBg.fillStyle(0xD97706, 1);
      logicBtnBg.fillRoundedRect(width / 2 - 300, logicBtnY - 30, 600, 70, 10);
    });
  ...
  showModeSelectionModal(workspaceType) {
    ...
    sandboxBtnBg.fillStyle(0x22C55E, 1);
    ...
    challengeBtnBg.fillStyle(0xEF4444, 1);
    ...
    sandboxBtn.on('pointerover', () => {
      sandboxBtnBg.clear();
      sandboxBtnBg.fillStyle(0x16A34A, 1);
      sandboxBtnBg.fillRoundedRect(width / 2 - 300, sandboxBtnY - 30, 600, 70, 10);
    });
    ...
    challengeBtn.on('pointerover', () => {
      ...
      challengeBtnBg.fillStyle(0xDC2626, 1);
      challengeBtnBg.fillRoundedRect(width / 2 - 300, challengeBtnY - 30, 600, 70, 10);
    });
