...
export default class MenuScene extends Phaser.Scene {
    ...
    createUI() {
        ...
        this.loginButton = this.add.text(rectX, rectY + 100, '▶ Start', {
            ...
            .on('pointerover', () => {
                if (this.isSwitchOn)
                    this.startButtonBackground.fillStyle(0x4F46E5, 1).fillRoundedRect(rectX - buttonWidth / 2, (rectY + 100) - buttonHeight / 2, buttonWidth, buttonHeight, cornerRadius);
            })
            .on('pointerout', () => {
                if (this.isSwitchOn)
                    this.startButtonBackground.fillStyle(0x6366F1, 1).fillRoundedRect(rectX - buttonWidth / 2, (rectY + 100) - buttonHeight / 2, buttonWidth, buttonHeight, cornerRadius);
            })
            .on('pointerdown', () => {
...
enableStartButton(isActive) {
        ...
        if (isActive) {
            ...
            this.startButtonBackground.fillStyle(0x6366F1, 1); 
